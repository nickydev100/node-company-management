...
module.exports  = (openRoutes,apiRoutes) =>  {
    ...
    apiRoutes.route('/createClient').all(policy.isManager)
        .post(client.createClient)        // TODO : create client

    apiRoutes.route('/listAllClients').all(policy.isManager)
        .get(client.listAllClients)       // TODO : list all client

    apiRoutes.route('/getClientById/:cli_id')
        .get(client.getClientById)        // TODO : Get 1 client by id

    apiRoutes.route('/updateClientById/:cli_id').all(policy.isManager)
        .put(client.updateClientById)     // TODO : update 1 client by id

    apiRoutes.route('/deleteClientById/:cli_id').all(policy.isManager)
        .delete(client.deleteClientById)

    apiRoutes.route('/createBulkClient').all(policy.isManager)
        .post(client.createBulkClient)    

    apiRoutes.route('/updateClientLogo/:cli_id')
